...
function About() {
  return (
    <div className="about">
      <p className="heading ab">About Diana</p>
      ...
      <p className="heading sus">
        Sustainable wellness is a big-picture, inside out approach
      </p>
      <p className="sub_heading dia">
        Diana is on a mission to create thoughtful, science-backed solutions for
        women who want to make informed decisions about their health and
        wellness.
      </p>
