...
function SelfCare() {
  return (
    <div className="selfCare">
      <p className="heading lib">Liberate your everyday wellness</p>
      <p className="sub_heading shop">Shop our self-care products</p>
      <p className="content">
      ...
      <img src={selfcare} className="selfimg" alt="img" />
    </div>
  );
}
